		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UTCL - Frontend",
									"targetURL": "#utclfrontend-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"utclfrontend-display": {
								"semanticObject": "utclfrontend",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=utclfrontend",
									"url": sap.ui.require.toUrl("utclfrontend")
								}
							}
						}
					}
