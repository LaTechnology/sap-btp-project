		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UTCL_Tech_Frontend",
									"targetURL": "#utcltechfrontend-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"utcltechfrontend-display": {
								"semanticObject": "utcltechfrontend",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=utcltechfrontend",
									"url": sap.ui.require.toUrl("utcltechfrontend")
								}
							}
						}
					}
