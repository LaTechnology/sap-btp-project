...
import cds.gen.btp_utcl_java.srv.utcldeliveryservice.DeliveryPeriod;
import cds.gen.btp_utcl_java.srv.utcldeliveryservice.Enduserofmaterial;
import cds.gen.btp_utcl_java.srv.utcldeliveryservice.GetEndUserofMaterialContext;
import cds.gen.btp_utcl_java.srv.utcldeliveryservice.GetSpecialInstructionContext;
import cds.gen.btp_utcl_java.srv.utcldeliveryservice.SpecialInstruction;
import cds.gen.btp_utcl_java.srv.utcldeliveryservice.SpecialInstruction_;
import cds.gen.btp_utcl_java.srv.utcldeliveryservice.UTCLDeliveryService_;
...
import cds.gen.mdkservices.Enduserofmaterial_;
import cds.gen.mdkservices.MdkServices_;


@Component
@ServiceName({UTCLDeliveryService_.CDS_NAME,MdkServices_.CDS_NAME})
public class utclDeliveryService implements EventHandler{

    @Autowired
    private PersistenceService persistenceService;

    private Logger log = LoggerFactory.getLogger(utclDeliveryService.class);
