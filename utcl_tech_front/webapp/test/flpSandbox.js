		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UltraTech Cement The Engineer's choice: India's No 1 Cement",
									"targetURL": "#utcltechfront-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"utcltechfront-display": {
								"semanticObject": "utcltechfront",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=utcltechfront",
									"url": sap.ui.require.toUrl("utcltechfront")
								}
							}
						}
					}
