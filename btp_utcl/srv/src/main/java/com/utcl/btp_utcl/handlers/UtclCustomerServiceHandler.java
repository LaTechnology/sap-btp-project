...
import cds.gen.com.utcl.srv.utclcustomerservice.CustomerType;
import cds.gen.com.utcl.srv.utclcustomerservice.GetCustomerTypeContext;
import cds.gen.com.utcl.srv.utclcustomerservice.UTCLCustomerService_;
import cds.gen.mdkservices.MDkServices_;

@Component
@ServiceName({UTCLCustomerService_.CDS_NAME,MDkServices_.CDS_NAME})
public class UtclCustomerServiceHandler implements EventHandler {
    ...
    private Logger log = LoggerFactory.getLogger(UtclCustomerServiceHandler.class);
