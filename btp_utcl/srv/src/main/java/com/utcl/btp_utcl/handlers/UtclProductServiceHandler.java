...
import cds.gen.com.utcl.srv.utcldeliveryservice.DeliveryPeriod_;
import cds.gen.com.utcl.srv.utclproductservice.CalculateNumberOfBagsContext;
import cds.gen.com.utcl.srv.utclproductservice.GetDeliveryPeriodContext;
import cds.gen.com.utcl.srv.utclproductservice.UTCLProductService_;
...
public class UtclProductServiceHandler implements EventHandler {
    ...
    public void getProductDetails() {
        ...
        ResponseEntity<Collection> response = restTemplate.getForEntity(url,
                Collection.class);
